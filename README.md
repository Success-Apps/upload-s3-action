...
| `aws_acl`               | (Optional) The ACL permission. (default: `public-read`) [More info here.](https://docs.aws.amazon.com/AmazonS3/latest/userguide/acl-overview.html#canned-acl)
